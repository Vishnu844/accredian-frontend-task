import footerLogo from "../assets/accredain-logo-footer.png";
...
const Footer = () => {
  const footerNavs = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: 2,
          title: "Email us: (For Product Management Queries): pm@accredian.com",
        },
        {
          id: 3,
          title: "Data Science Admission Helpline:+91 9079653292 (9 AM - 7 PM)",
        },
        {
          id: 4,
          title: "Product Management Admission Helpline:+91 9625811095",
        },
        {
          id: 5,
          title: "Enrolled Student Helpline: +91 7969322507",
        },
        {
          id: 6,
          title:
  ...
  return (
    <footer className="pt-10 bg-footer-bg text-white">
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="flex justify-between items-center gap-12">
          <div className="max-w-lg">
            <img src={footerLogo} alt="footer-logo" width={110} height={38} />
          </div>
          <div>
            <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-white bg-primary rounded-lg">
              Subscribe 1-on-1 Call Now
            </button>
